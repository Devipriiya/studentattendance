...
$sql = "INSERT INTO users (email,fname,lname,dob,attend,age_y,age_m,password1,password2,dp,gender,date_time) VALUES ('$email','$fname','$lname','$dob','$attend','$age_y','$age_m','$password','$password','$filename','$gender','$date')";
